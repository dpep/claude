...
- **git** — branching, commits, rebasing, repo optimization. Subskill: `optimize` (pack consolidation, worktree + branch cleanup, fetch refspec narrowing). Reference: `worktrees` (multi-agent coordination, load on demand).
